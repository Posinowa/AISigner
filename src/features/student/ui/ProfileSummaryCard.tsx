  ...
  return (
    <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl shadow-md p-6 space-y-5 border border-blue-100">
      <div className="flex items-center gap-2">
        ...
        <h2 className="text-xl font-semibold text-gray-900">AI Profil Analizi</h2>
      </div>

      <div className="bg-white rounded-lg p-4 space-y-3">
        <div className="flex items-center gap-2">
          <span className="text-sm font-medium text-gray-600">Seviye:</span>
      ...
      <div className="bg-white rounded-lg p-4">
        ...
        <div className="flex flex-wrap gap-2">
          {tracks.map((track, i) => (
            <span
              key={i}
              className="px-3 py-1.5 bg-gradient-to-r from-blue-100 to-indigo-100 text-blue-800 rounded-lg text-sm font-medium border border-blue-200"
            >
              {track}
            </span>
          ))}
